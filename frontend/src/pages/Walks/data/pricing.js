...
export default [
  {
    ...
    historicPeople: (
      <>
        <strong>City</strong>: William Wilberforce, John Wyclif, John Wesley,
        William Tyndale, George Whitefield, Thomas Watson, Lord Shaftesbury,
        John Newton.
        <br />
        <strong>British Museum</strong>: Abraham, Hezekiah, Isaiah, Jehu,
        Elijah, Daniel, Esther, Nehemiah, Paul.
      </>
    ),
